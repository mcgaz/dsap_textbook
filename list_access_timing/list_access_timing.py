...
def main():
    ...
    for x in range(xmin, xmax+1, 1000):
        ...
        # Creates a list of size x with all zeroes
        lst = [0] * x
        ...
        # Time before 1000 test retrievals
        ...
        for v in range(1000):
            ...
            index = random.randint(0, v)
            val = lst[index]
            prod = prod * val
        # Time after the 1000 test retrievals
        endtime = datetime.datetime.now()

        # The difference in timer between start and end
        deltaT = endtime - starttime

        # Divide by 1000 for the average access time but    
        # also multiply by 1000000 for microseconds
    ...
    # This part of the program tests access at 100 random locations within a list of 
    # 200,000 elemetns to see that all the locations can be accessed in about the
    # same amount of time
    xList = lst
    yList = [0] * 200000
